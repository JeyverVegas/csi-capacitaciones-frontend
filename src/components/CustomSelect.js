...
const CustomSelect = ({styles, options, selectedValue, handleInputChange, inputValue, isLoading, onSelectValue, optionLabel, isEmptyMessage}) => {
    ...
    return (
        <div className="position-relative">
            ...
            {
                showOptions &&
                <div className={`border shadow p-2 mt-1 position-absolute w-100 custom-scrollbar ${background?.value === 'dark' ? 'scrollbar-light' : 'scrollbar-dark'}`} style={{top: '40px', left: 0, maxHeight: 150, zIndex: 1, overflowY: 'auto'}} ref={inputOptionContainer}>
                    {
                        isLoading ?
