...
const MyAccountAccreditationProcessesColumns = [
    {
        Label: TableCheck,
    ...
    {
        Label: () => 'Acciones',
        Component: (values) => <ActionDropdown updateOptionString="Ver" {...values} />
    }
];

export default MyAccountAccreditationProcessesColumns;
