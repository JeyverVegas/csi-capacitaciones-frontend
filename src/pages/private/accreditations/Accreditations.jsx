...
const Accreditations = () => {
    ...
    const [{ accreditations: records, total, numberOfPages, loading }, getRecords] = useAccreditations({ params: { ...filters }, options: { useCache: false } });
    ...
    return (
        <div>
            ...
            <CustomTable
                ...
                filters={filters}
                excelUrl={'/accreditations/export/excel'}
            />
        </div>
    )
}
