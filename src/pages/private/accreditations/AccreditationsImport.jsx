...
import excelTemplate from "../../../assets/excels/accreditations-template.xlsx";
...
const AccreditationsImport = () => {
    ...
    const [{ data: updateData, loading: updateLoading }, importAccreditations] = useAxios({ url: `/accreditations/import`, method: 'post' }, { manual: true, useCache: false });
            ...
            <div className="card-header">
                <div className="row aling-items-center col-md-12">
                    <div className="col-md-6">
                        <h4>Importar Acreditaciones</h4>
                    </div>
                    <div className="col-md-6 text-end">
                        <a href={excelTemplate} download="accreditations-template.xlsx" className="btn btn-xs btn-success">
                            Descargar plantilla
                        </a>
                    </div>
                </div>
