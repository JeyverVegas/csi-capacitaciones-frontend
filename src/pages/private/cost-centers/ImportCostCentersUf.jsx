...
import excelTemplate from "../../../assets/excels/uf-amounts-template.xlsx";
import usePlanningProcesses from "../../../hooks/usePlanningProcesses";

const ImportCostCentersUf = () => {
    ...
    const [{ data: updateData, loading: updateLoading }, importValues] = useAxios({ url: `/cost-centers/uf-amounts-excel`, method: 'post' }, { manual: true, useCache: false });
...
export default ImportCostCentersUf;