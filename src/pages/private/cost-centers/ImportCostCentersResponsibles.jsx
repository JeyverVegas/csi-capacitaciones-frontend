...
import excelTemplate from "../../../assets/excels/responsibles-template.xlsx";

const ImportCostCentersResponsibles = () => {

    const [file, setFile] = useState(null);

    const { setLoading, setCustomAlert } = useFeedBack();

    const [{ data: updateData, loading: updateLoading }, importProducts] = useAxios({ url: `/cost-centers/responsibles-excel`, method: 'post' }, { manual: true, useCache: false });
...
export default ImportCostCentersResponsibles;